...
This is a sample Cisco Webex Teams bot built with Botkit.
...
var mongoStorage = require('botkit-storage-mongo')({mongoUri: process.env.mongo_url, tables: [process.env.table_publishers, process.env.table_subscribers, process.env.table_notifications]});
